  ...
  return (
    <nav className="md:mt-10 mx-2 flex md:block">
      ...
      >
        ...
        <span className="mx-4 md:text-sm text-lg font-normal">Contacto</span>
      ...
      >
        ...
        <span className="mx-4 text-sm font-normal">Configuración</span>
        <span className="flex-grow text-right"></span>
      </NavLink> */}

      <NavLink
        to={"/slider"}
        className="hover:text-gray-800 hover:bg-gray-100 flex items-center py-1 px-2 my-2 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200  text-gray-600 dark:text-gray-400 rounded-lg "
        href="#"
      >
        <svg
          width="20"
        ...
        <span className="mx-4 md:text-sm text-lg font-normal">Slider</span>
        <span className="flex-grow text-right"></span>
      </NavLink>
    </nav>
  );
